...
**/
#ifndef MY_RENDERING_RAY_CASTING_H
#define MY_RENDERING_RAY_CASTING_H
...
class RayCastingMine : public BaseVolumeRenderer
{
public:
    RayCastingMine();
    virtual ~RayCastingMine();

    //////////////////////////////////////////
    // Virtual base functions
    virtual const char* GetName() { return "My Ray Casting"; }
